...
def get_args_parser():
    parser = argparse.ArgumentParser('BTRFormer pre-training', add_help=False)
    ...
    parser.add_argument('--MODEL', default='', type=str, metavar='MODEL',
                        help='Name of model to select')
    parser.add_argument('--model', default='MAE_BTRFormer', type=str, metavar='MODEL',
    ...
    parser.add_argument('--epochs', type=int, default=0, metavar='NN',
                        help='epochs')
...
def main(args):
    ...
    model = models_BTR.__dict__[args.model](norm_pix_loss=args.norm_pix_loss, img_size=img_size,
                                             img_patch_size=patch_size, window_size=window_size)

...
def save_checkpoint(config, epoch, model, max_accuracy, max_f1, optimizer, lr_scheduler, scaler, logger):
...
def reduce_tensor(tensor):
    ...
    # rt /= misc.get_world_size()

    # by ycc
    rt = misc.all_reduce_mean(tensor)
    return rt
